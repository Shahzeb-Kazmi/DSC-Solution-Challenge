...
class DetailsScreenState extends State<DetailsScreen> {
  DetailsScreenState({@required this.index});
  final int index;
      ...
      body: Stack(
        children: <Widget>[
          Positioned(
            ...
            child: Image.network(
              "https://firebasestorage.googleapis.com/v0/b/tulba-adf4f.appspot.com/o/backgrounds%2Fbackground6.jpg?alt=media&token=7149d8a1-754b-4f35-bac4-528ccc18a696",
              fit: BoxFit.cover,
